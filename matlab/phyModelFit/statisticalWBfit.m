function [m,n,l,A] = statisticalWBfit(Imef,Ihpf,Ilpf,Ivf,z,isplot)
    ...
    %for i=1:3 %each color independetly
        ...
        bound=min(Ilpf,2);
        fun = @(a) [...%(Imf(:,1)+Imf(:,1)+Imf(:,1)-3*(a(1)*z+a(2)+a(5)*z.^2)),...
...
%                     2*(Ilpf(:,1))*a(3)-(Ilpf(:,3)),...
                ...
                1000000 * max(0, -bound +(a(1)*z+a(2)+a(5)*z.^2)),...
                    ...
                    0.5 * (Imef(:,i(1))-(a(1)*z+a(2)+a(5)*z.^2))*a(3)-(Imef(:,i(2))-(a(1)*z+a(2)+a(5)*z.^2)),...
                    0.5 * (Imef(:,i(1))-(a(1)*z+a(2)+a(5)*z.^2))*a(3)-(Imef(:,i(3))-(a(1)*z+a(2)+a(5)*z.^2))*a(4),...
...
%                     (Ihpf(:,1)-(a(1)*z+a(2)+a(5)*z.^2))*a(3)-(Ihpf(:,3)-(a(1)*z+a(2)+a(5)*z.^2)),...
    ...
    if isplot
        ...
        plot(z,(Imef(:,i)-(m*z+n+l*z.^2))*A(i)+(m*z+n+l*z.^2),'Marker','.','Color',rgb(i,:));
        hold on;
